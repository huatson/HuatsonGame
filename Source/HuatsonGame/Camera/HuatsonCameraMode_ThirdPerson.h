...
#include "HuatsonPenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "HuatsonCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UHuatsonCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UHuatsonCameraMode_ThirdPerson : public UHuatsonCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FHuatsonPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
