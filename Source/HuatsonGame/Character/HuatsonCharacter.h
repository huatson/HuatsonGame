...
class UHuatsonPawnExtensionComponent;
class UObject;
struct FFrame;
struct FGameplayTag;
...
/**
 * FHuatsonReplicatedAcceleration: Compressed representation of acceleration
 */
USTRUCT()
struct FHuatsonReplicatedAcceleration
{
	GENERATED_BODY()
...
public:
	...
	UE_API AHuatsonCharacter(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
private:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Huatson|Character", Meta = (AllowPrivateAccess = "true"))
	TObjectPtr<UHuatsonPawnExtensionComponent> PawnExtComponent;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Huatson|Character", Meta = (AllowPrivateAccess = "true"))
	TObjectPtr<UHuatsonCameraComponent> CameraComponent;

	UPROPERTY(Transient, ReplicatedUsing = OnRep_ReplicatedAcceleration)
	FHuatsonReplicatedAcceleration ReplicatedAcceleration;
